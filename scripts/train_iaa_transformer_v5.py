...
torch.save(model.state_dict(), '/scratch/kdhungel/iads-project/models/iaa_transformer_v5.pth')
print("Model saved.")
...
with open('/scratch/kdhungel/iads-project/results/iaa_transformer_v5_report.txt', 'w') as f:
