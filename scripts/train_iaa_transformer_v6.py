...
for i, label in enumerate(le.classes_):
    class_weights[i] = 1.0 / class_freq_original[label]
...
torch.save(model.state_dict(), '/scratch/kdhungel/iads-project/models/iaa_transformer_v6.pth')
print("Model saved.")
...
with open('/scratch/kdhungel/iads-project/results/iaa_transformer_v6_report.txt', 'w') as f:
