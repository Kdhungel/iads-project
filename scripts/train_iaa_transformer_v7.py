...
print("Class weights and frequency bias computed.")
...
torch.save(model.state_dict(), '/scratch/kdhungel/iads-project/models/iaa_transformer_v7.pth')
print("Model saved.")
...
with open('/scratch/kdhungel/iads-project/results/iaa_transformer_v7_report.txt', 'w') as f:
