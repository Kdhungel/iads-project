...
print(f"Device: {device} — IAA without SMOTE")

# Load scaled data WITHOUT SMOTE
...
# Wait — we need unsmoted scaled data
# Load clean unscaled, scale it, no SMOTE
...
torch.save(model.state_dict(), '/scratch/kdhungel/iads-project/models/iaa_no_smote.pth')
...
with open('/scratch/kdhungel/iads-project/results/iaa_no_smote_report.txt', 'w') as f:
