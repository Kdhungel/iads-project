...
print(f"Device: {device} — Variant A: attention dropout 0.3, alpha=0, Seed: {SEED}")
...
torch.save(model.state_dict(), f'/scratch/kdhungel/iads-project/models/variantA_seed{SEED}.pth')
print("Model saved.")
...
with open(f'/scratch/kdhungel/iads-project/results/variantA_seed{SEED}_report.txt', 'w') as f:
